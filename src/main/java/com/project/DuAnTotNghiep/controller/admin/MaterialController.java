...
public class MaterialController {
    ...
    public String addMaterial(Model model, @Validated @ModelAttribute("Material") Material material, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("successMessage", "Thêm loại trà mới thành công");
    ...
    public String update(@PathVariable("id") Long id,
            ...
            try {
                ...
                redirectAttributes.addFlashAttribute("successMessage", "loại trà " + material1.getCode()  + " đã được cập nhật thành công");
