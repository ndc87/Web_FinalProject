...
public class SizeController {
    ...
    public String addSize(Model model, @Validated @ModelAttribute("Size") Size size, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("successMessage", "Thêm Size mới thành công");
        }
        catch (Exception e) {
    ...
    public String update(@PathVariable("id") Long id,
        ...
        if (optional.isPresent()) {
            try {
                ...
                redirectAttributes.addFlashAttribute("successMessage", "Size được cập nhật thành công");
